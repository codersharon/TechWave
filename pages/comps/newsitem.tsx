...
const NewsItem = (props) => {
	...
	return <>
		<div className='m-2 bg-slate-900 text-white border-2 border-black w-[724px] p-2 rounded-lg'>
			<img src={img?.search(/https:/)==0? img : `/no.webp`}  className='w-[724px] h-[362px] blur-none rounded' />
