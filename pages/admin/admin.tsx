  ...
  return (
    <>
			...
			<div className='mt-5 flex flex-col'>
				...
				<input type='text' value={postContent} onChange={(e)=>{setPostContent(e.target.value)}} id='postcontent' className='m-2 w-fit bg-black text-white mx-5 rounded-lg p-2' placeholder='PostContent'  />
